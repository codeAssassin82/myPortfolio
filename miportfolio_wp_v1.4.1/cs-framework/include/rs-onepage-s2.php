...
if ($page_type == 'slide_page'){?>
	<div class="content-wrap-in <?php echo esc_html($page_type);?>" id="<?php print str_replace("-","-",$post->post_name);?>">
		<div class="slide-page-content" <?php print $bg_page_color;?>>
...
<?php } else { ?>
	...
	<div class="content-wrap-in <?php echo esc_html($page_type);?>" id="<?php print str_replace("-","-",$post->post_name);?>" <?php print $bg_page_color;?>>
		<?php the_content();?>
	</div>
<?php }
