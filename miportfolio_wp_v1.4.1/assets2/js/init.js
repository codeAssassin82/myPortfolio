...
function main_menu(){
	...
	var win_widht = $(window).width()- $('#p_name').width();
	var li_width = ( (win_widht/(li_count-1)) );
	$('nav ul li.hover-effect').width(li_width - 0.2);

}

/********Multipage*****************/
if ($('.multipage1').length && $('.menu-style-2').length){
	$('.multipage1').css({'padding-top' : $('.menu-style-2 nav > ul').height()+40});
}
...
/**********************************/
var post_id = '';
$('nav .hover-effect a').click(function(){
...
function miportfolio(){
	...
	/** Nice Scroll **/
	 ...
	 $(".slide-page-content").niceScroll({cursorcolor:"#c8bd9f"});
