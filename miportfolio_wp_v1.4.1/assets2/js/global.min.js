...
! function (a, b, c) {
    ...
    d.utils.init = function () {
        ...
        b > 100 ? d.cache.header.addClass("") : $(".page").hasClass("act") || d.cache.header.removeClass(""), b >= a.data.pageHeight ? $("#page").addClass("footer-act") : b <= a.data.pageHeight - 118 && $("#page").removeClass("footer-act"), b >= d.cache.workPosition - 120 ? $("#js-go-to-work").addClass("act") : $("#js-go-to-work").removeClass("act")
    }, d.utils.onScrollDetail = function (a) {
		
        var b = d.cache.window.scrollTop();
        $("html, body").stop(), b > 100 ? d.cache.header.hasClass("act") || $('.hight-head').addClass("small-head") && $('.scroll-top').removeClass("hidden") 
: $("#page").hasClass("act") || $('.hight-head').removeClass("small-head") && $('.scroll-top').addClass("hidden"), b >= a.data.pageHeight ? $(".page").addClass("footer-act") : b <= a.data.pageHeight - 118 && $(".page").removeClass("footer-act")
        ...
        a.on("click", function (a) {
            ...
            if ("/#work" !== e) {
                ...
                d.utils.scrollto(b), ("#about" === e || "#contact" === e || "#expertise"=== e) && d.utils.openLayer(e), c.addClass("act")
            }
            $(e).length && a.preventDefault()
        })
    }, d.utils.openLayer = function (a) {
        d.utils.scrollto(0), d.cache.header.addClass("act"), $(".page").addClass("act"), $(".overlay").addClass("act"), $(a).addClass("act"), "#about" === a && d.cache.videoImage !== c && (d.cache.isLayerEgo = !0, d.utils.initVideo()), d.cache.header.addClass(""), d.cache.isLayerOpened = !0, d.cache.isDetail || (d.cache.window.off("scroll onscroll", d.utils.onParallax), d.cache.window.off("scroll onscroll", d.utils.onReduceOpacity))
    }, d.utils.closeLayerInit = function () {
        $(".overlay, .about .close, .contact .close , .expertise .close , #p_portfolio").on("click", function (a) {
            a.preventDefault(), d.utils.closelayer()
        })
    }, d.utils.closelayer = function () {
        d.cache.header.removeClass("act"), $(".page").removeClass("act"), $(".overlay").removeClass("act"), $("#about").removeClass("act"), $("#contact").removeClass("act"),$("#expertise").removeClass("act"), d.cache.isLayerEgo = !1, clearInterval(d.cache.videoInterval), $(".act", d.cache.header).removeClass("act"), d.cache.isDetail || (d.cache.header.removeClass(""), d.cache.isLayerOpened = !1, d.cache.body.css("overflow", ""), d.utils.initParallax(d.cache.parallaxSpeed), d.utils.initReduceOpacity(d.cache.maxOpacity))
